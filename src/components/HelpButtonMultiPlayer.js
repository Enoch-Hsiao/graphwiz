    ...
    return (
        ...
        >
          <div style={{ width: 600 }}>
            ...
            <DialogContent dividers>
                <Typography variant="h6">How Multiplayer Works</Typography>
                <Typography variant="body1">You have 20 seconds to guess the correct equation. The lowest score wins. Ties are broken by seconds taken to answer.</Typography>
            </DialogContent>
            <DialogContent dividers>
